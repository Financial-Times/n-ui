	...
	sections: [
		...
		},
		{
			...
			content: {
				...
				body: 'Discover thousands of topics to track. Then you can stay updated on those most important to you, all in one place.',
				imageAlt: 'Illustration of the "Companies" page, showing an "Added" button next to the page heading',
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/myft-7.svg',
				ctas: [{
					url: '/tour/myft',
		...
		},
		{
			...
			content: {
				...
				body: 'Start the conversation. Standard users can share up to 10 articles a month with colleagues, friends or family, Premium user can share up to 20  – absolutely free. Even if they’re not subscribed to the FT.',
				imageAlt: 'Illustration of the Gift Article button in article pages',
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/gift-7.svg'
			}
		},
		{
			...
			content: {
				...
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/fastft-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
		...
		},
		{
			...
			content: {
				...
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/markets-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
		...
		},
		{
			...
			content: {
				...
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/alerts-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
		...
		},
		{
			...
			content: {
				...
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/briefings-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
		...
		{
			id: 'email-briefings-l',
			queryStringId: 'email-briefings',
			settings: {
				hasTourPageLink: false,
				isDismissable: false,
				size: 'l'
		...
		},
		{
			...
			content: {
				title: 'You can now add, edit and track investments on all your devices',
				imageAlt: 'Illustration of the FT Portfolio page',
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/portfolio-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
		...
		},
		{
			...
			content: {
				title: 'FT Portfolio tool',
				body: 'Add, edit and track investments on all your devices. If you’re not quite ready to make the move, you can still access the old portfolio tool.',
				imageAlt: 'Illustration of the FT Portfolio page',
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/portfolio-7.svg',
				ctas: [{
					url: 'http://markets.ft.com/data/portfolio/dashboard',
					label: 'Check your Portfolio'
				}]
			}
		},
		{
			id: 'special-reports-s',
			settings: {
				hasTourPageLink: true,
				isDismissable: false,
				size: 's'
			...
			content: {
				...
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/reports-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
		...
		{
			id: 'special-reports-l',
			queryStringId: 'special-reports',
			settings: {
				hasTourPageLink: false,
				isDismissable: false,
				size: 'l'
		...
		},
		{
			...
			content: {
				...
				imageUrl: 'https://www.ft.com/__assets/creatives/tour/feed-7.svg',
				ctas: [{
					url: '/tour',
					label: 'More tips'
				}]
